...
QT_STATIC_CONST_IMPL double GraphScaleMap::LogMin = 1.0e-150;
QT_STATIC_CONST_IMPL double GraphScaleMap::LogMax = 1.0e150;

//! Constructor for a linear transformation
GraphScaleTransformation::GraphScaleTransformation(Type type):
    d_type(type)
{
}

//! Destructor
GraphScaleTransformation::~GraphScaleTransformation()
{
}

//! Create a clone of the transformation
GraphScaleTransformation *GraphScaleTransformation::copy() const
{
    return new GraphScaleTransformation(d_type);
}
...
double GraphScaleTransformation::xForm(
...
double GraphScaleTransformation::invXForm(double p, double p1, double p2, 
...
GraphScaleMap::GraphScaleMap():
    ...
    d_cnv(1.0)
{
    d_transformation = new GraphScaleTransformation(
        GraphScaleTransformation::Linear);
}

//! Copy constructor
GraphScaleMap::GraphScaleMap(const GraphScaleMap& other):
    d_s1(other.d_s1),
    d_s2(other.d_s2),
    d_p1(other.d_p1),
    d_p2(other.d_p2),
...
//! Assignment operator
GraphScaleMap &GraphScaleMap::operator=(const GraphScaleMap &other)
{
    d_s1 = other.d_s1;
    d_s2 = other.d_s2;
    d_p1 = other.d_p1;
...
*/
void GraphScaleMap::setTransformation(
    GraphScaleTransformation *transformation)
{
...
const GraphScaleTransformation *GraphScaleMap::transformation() const
{
...
*/
void GraphScaleMap::setScaleInterval(double s1, double s2)
{
    ...
    if ( d_transformation->type() != GraphScaleTransformation::Other )
        newFactor();
}
...
*/
void GraphScaleMap::setPaintInterval(int p1, int p2)
{
    d_p1 = p1;
    d_p2 = p2;
...
/*!
  ...
  \param p2 second border
*/
void GraphScaleMap::setPaintXInterval(double p1, double p2)
{
    d_p1 = p1;
    d_p2 = p2;
...
void GraphScaleMap::newFactor()
{
    ...
    {
        case GraphScaleTransformation::Linear:
            d_cnv = (d_p2 - d_p1) / (d_s2 - d_s1); 
            break;
        case GraphScaleTransformation::Log10:

...
void Window::init()
{
    ...
    m_data->renderer->fillRect(new GraphLib::Point(80, 50), 
            new GraphLib::Point(100, 70), new QColor(Qt::red));
    ...
    m_data->renderer->fillEllipse(new GraphLib::Point(100, 100), 
            20, 20, new QColor(Qt::cyan));

    GraphLib::Point polyline[] = {GraphLib::Point(110, 210), 
        GraphLib::Point(120,210), 
        GraphLib::Point(300,40), 
        GraphLib::Point(130,220)};

...
class Window::PrivateData
{
    public:
        ...
        GraphLib::GraphPathInteractiveRenderer *interactiveRenderer;
...
void Window::init()
{
    ...
    m_data->interactiveRenderer = new GraphLib::GraphPathInteractiveRenderer((GraphLib::GraphRenderer *)m_data->renderer);
    //
    ...
    m_data->renderer->drawRect(new GraphLib::Point(50, 50), 
            new GraphLib::Point(70, 70), new QColor(Qt::blue));
